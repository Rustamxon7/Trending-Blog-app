...
RSpec.feature 'Users Page' do
  feature 'shows users' do
    background do
      ...
      @user2 = User.create(name: 'Ahmad', bio: 'Ahmad is Full-Stack developer', photo: 'https://avatars.githubusercontent.com/u/74506933?v=4', email: 'great@gmail.com', confirmed_at: Time.now, password: '123456')
